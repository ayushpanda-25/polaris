...
class SkylitGroundTruth:
    ...
    spot: float
    king_strike: float
    king_expiry: str       # YYYY-MM-DD
    king_value_k: float    # $ thousands, signed
...
SPY_2026_04_07 = [
    SkylitGroundTruth(
        ...
        spot=656.72,
        king_strike=657.0,
        king_expiry="2026-04-07",  # 0DTE
        king_value_k=448_043.6,
        notes="King shifted 657→658 when spot crossed 657",
    ),
    SkylitGroundTruth(
        timestamp="15:46:31",
        ticker="SPY",
        spot=658.14,
        king_strike=658.0,
        king_expiry="2026-04-07",
        king_value_k=437_595.2,
    ),
    SkylitGroundTruth(
        timestamp="15:47:23",
        ticker="SPY",
    ...
    SkylitGroundTruth(
        ...
        spot=659.02,
        king_strike=660.0,
        king_expiry="2026-04-08",
        king_value_k=49_004.9,
        notes="0DTE reshuffle: King jumped from 658@0DTE to 660@next-day",
    ),
]
