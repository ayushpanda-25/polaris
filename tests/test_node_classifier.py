...
def test_sirius_is_largest_absolute_value():
    cells = [
    ...
    assert nm.sirius.strike == 505.0
    assert nm.sirius.role == "sirius"
    assert nm.sirius.value == -200.0


def test_gatekeepers_sit_between_spot_and_sirius():
    spot = 500.0
    cells = [
        GEXCell(500.0, "2026-04-18", gex_value=-50.0, vex_value=0),
